...
const Navbar = () => {
  ...
  return (
    <div className=
      "fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[95%] md:w-[90%] lg:w-[80%] bg-white shadow-lg rounded-xl px-6 md:px-16 py-3 flex items-center justify-between transition-all duration-300">
      {/* Logo dinámico */}
      ...
      <div
        className={`
    /* Móvil: menú lateral pantalla completa */
    ...
    /* Desktop: tu estilo original intacto */
